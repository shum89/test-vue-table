<template>
  <form @submit.prevent="addData">
    <fieldset>
      ...
      <label for="age">
        Возраст
        <input v-model="phone" type="number" id="age" />
      </label>
  ...
  <div v-if="list.length > 0" class="table" role="grid" aria-colcount="3">
    ...
    <div class="table__row-group" role="rowgroup">
      <div class="table__row" v-for="listItems in list" role="row">
        <span role="gridcell" aria-colindex="1">Fred</span>
        <span role="gridcell" aria-colindex="2">Jackson</span>
        <span role="gridcell" aria-colindex="3">555-1234</span>
      </div>
    </div>
  </div>
</template>
