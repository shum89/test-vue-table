<template>
  <form class="form" @submit.prevent="onSubmit">
    <fieldset class="form__fieldset">
      ...
      <label for="lastName">
        <span>Фамилия</span>
        <input class="form__input" v-model="person.lastName" type="text" id="lastName" />
      </label>

      <label for="age">
        <span>Возраст</span>
        <input class="form__input" v-model="person.age" type="number" id="age" />
      </label>
...
input:-webkit-autofill:focus {
  -webkit-box-shadow: var(--input-shadow-active) !important;
  transition: var(--shadow-transition);
  box-shadow: var(--input-shadow-active) !important;
