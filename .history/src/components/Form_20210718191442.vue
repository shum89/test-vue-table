<template>
  <orm class="form" @submit="onSubmit">
    <fieldset class="form__fieldset">
      <label class="form__label" for="firstName">
        <span class="form__label-text">Имя</span>

        <input autocomplete="off" type="search" class="form__input" v-bind="field" id="firstName" />
      </label>
...
export default {
  setup(_, { emit }) {
    ...
    return { onSubmit, person, onKeyPress, firstName, lastName, age };
  },

  name: 'Form',
  inheritAttrs: false,
  components: { Field, Form: 'form-vue' },
};
</script>
